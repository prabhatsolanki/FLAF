...
if __name__ == "__main__":
    ...
    parser.add_argument('--wantSignals', required=True, action='store_true')
    ...
    page_cfg_custom = os.path.join(os.environ['ANALYSIS_PATH'],f'config', f'plot/Run3_2022.yaml') # to be fixed!!
